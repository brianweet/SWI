...
datapath = 'result_data';  % different folder for each experiment
% opt.inputFormat = 'row';
opt.algName = 'BFOA E.COLI BACTERIAL FORAGING';
...
dimensions = [ 10, 20, 40];  % small dimensions first, for CPU reasons
  ...
  for ifun = functions
    for iinstance = instances
      ...
      for restarts = 0:maxrestarts
        ...
        abfoa('fgeneric', dim, fgeneric('ftarget'), ...
